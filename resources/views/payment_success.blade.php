...
<div class="mt-20 mb-20 flex items-center justify-center w-full">
    <div class="bg-white p-8 rounded-lg shadow-md text-center max-w-md w-full ">
        ...
        @if(session('payment_error'))
            ...
            <p class="text-gray-700 mb-2">Пожалуйста, <a href="{{ route('user.refreshBalance') }}" class="text-blue-500 hover:underline">обновите баланс вручную</a> или обратитесь в поддержку.</p>
        @else
            <p class="text-gray-700 mb-2">Сумма пополнения: <span class="font-bold">{{ number_format($transaction->amount, 2) }} руб.</span></p>
            <p class="text-gray-700 mb-2">Текущий баланс: <span class="font-bold">{{ number_format(auth()->user()->balance, 2) }} руб.</span></p>
